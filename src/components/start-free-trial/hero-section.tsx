...
import FreeTrialOverlay from "@/components/start-free-trial/FreeTrialOverlay";
        ...
        <div className="container-wrapper relative z-10 flex justify-start pt-5 sm:pt-10 lg:pt-20">
          <div className="w-full md:w-2/4 xl:w-2/5 text-start px-4 space-y-9 -mt-15 md:mt-0">
            ...
            <div className="flex flex-col gap-3">
              <button  onClick={() => setOpen(true)} className="w-full cursor-pointer rounded-full bg-linear-to-r from-[#33FCFE] to-[#010B66] text-white text-[15px] lg:text-[18px] p-[3px]">
